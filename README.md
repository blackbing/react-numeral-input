# react-numeral-input [![Build Status](https://api.travis-ci.org/blackbing/react-numeral-input.svg?branch=feature%2Fes6)](https://travis-ci.org/blackbing/react-numeral-input)
